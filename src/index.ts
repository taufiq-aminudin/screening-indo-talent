...
</style></head><body><div id="root" class="wrap"><div class="card loading"><h2>Super Admin</h2><p>Authenticated. Loading dashboard…</p><noscript><p>JavaScript diperlukan untuk dashboard Super Admin.</p></noscript></div></div><script src="/super-admin-v51.js?v=51" defer></script></body></html>`);
  }
  return c.html(`<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Super Admin · ${c.env.APP_NAME}</title><style>
