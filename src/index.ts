...
app.get("/super-admin-v49.js", async c=>{
  try{
    if(c.env.ASSETS){
      const r=await c.env.ASSETS.fetch(new Request(new URL("/super-admin-v49.js",c.req.url)));
